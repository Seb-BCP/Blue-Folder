...
class BlueFolder {
    ...
    addTimesheetRow() {
        ...
        row.innerHTML = `
            ...
            <td><button type="button" class="shift-button">DS</button></td>
        ...
        row.querySelectorAll('.shift-button').forEach(button => {
            button.addEventListener('click', () => {
                ...
                button.closest('td').classList.toggle('night-shift');
                this.updateRowCalculations(button.closest('tr'));
            });
        });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addRowButton) {
        ...
        addRowButton.addEventListener('click', () => blueFolder.addTimesheetRow());
    }
